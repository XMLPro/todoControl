...
let warningTask = new __WEBPACK_IMPORTED_MODULE_0_vue__["a" /* default */]({
    el: '#warning-task',
    computed:{
...
let newTask = new __WEBPACK_IMPORTED_MODULE_0_vue__["a" /* default */]({
    el: '#new-task',
    data: {
        content: "",
    },
    ...
    methods:{
        addTask: function(){
            ...
            __WEBPACK_IMPORTED_MODULE_2_axios___default.a.post('/task/add', {content: this.content}).
...
let focusTask = __WEBPACK_IMPORTED_MODULE_0_vue__["a" /* default */].extend({
    ...
    methods: {
        ...
        close: function() {
            ...
            __WEBPACK_IMPORTED_MODULE_2_axios___default.a.post('/task/update', this.task).
...
let taskList = new __WEBPACK_IMPORTED_MODULE_0_vue__["a" /* default */]({
    el: '#task-list',
    components: {
    ...
    created: function() {
        __WEBPACK_IMPORTED_MODULE_2_axios___default.a.post('/task/all')
            .then((response) => {
        ...
        __WEBPACK_IMPORTED_MODULE_2_axios___default.a.post('/place/all').
            then((response) => {
                response.data.forEach((data) =>{
